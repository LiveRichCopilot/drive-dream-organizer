  ...
  return (
    <div className="min-h-screen p-6 bg-gray-300/10 relative">
      ...
      <div className="bg-white/5 border border-white/20 rounded-2xl p-6 mb-8">
        ...
        <div className="mb-6">
          <div className="bg-black/40 backdrop-blur-[25px] backdrop-saturate-[200%] border border-white/15 rounded-2xl p-6 shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* All Files Option */}
              <div 
                className="bg-gray-300/20 backdrop-blur-sm border-2 border-white/5 hover:border-white/15 hover:bg-gray-300/30 p-4 cursor-pointer rounded-xl transition-all opacity-50"
                onClick={() => {
                  setSelectedFolderId(undefined);
                  loadVideos();
                }}
