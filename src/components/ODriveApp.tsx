...
const ODriveApp = () => {
  ...
  return (
    <div className="min-h-screen p-6 bg-gray-300/10 relative">
      {/* Heavy grain overlay */}
      ...
      <div className="bg-white/5 border border-white/20 rounded-2xl p-6 mb-8 shadow-[0_4px_24px_6px_rgba(0,0,0,0.10)]">
        ...
        <div className="mb-6">
          <div className="bg-black/40 backdrop-blur-[25px] backdrop-saturate-[200%] border border-white/15 rounded-2xl p-6 shadow-lg shadow-[inset_0_2px_8px_rgba(0,0,0,0.2)]" style={{
      ...
      {filteredVideos.length === 0 && (
        <div className="bg-white/5 backdrop-blur-[20px] backdrop-saturate-[180%] border border-white/10 rounded-2xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.15),0_4px_24px_6px_rgba(0,0,0,0.10)] text-center py-12 px-6">
