  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div 
        className="absolute inset-0 z-0"
        style={{
          backgroundImage: `url(/lovable-uploads/74d305df-9e51-456a-9ce6-df348714ce4e.png)`,
          backgroundSize: 'cover',
          backgroundPosition: 'center',
          backgroundAttachment: 'fixed'
        }}
      ...
      {/* Header */}
      <div className="bg-white/5 border border-white/20 rounded-2xl p-6 mb-8 shadow-[0_4px_24px_6px_rgba(0,0,0,0.10)] mx-[5%] mt-[3%]">
      ...
      {filteredVideos.length === 0 && (
        <div className="bg-white/5 backdrop-blur-[20px] backdrop-saturate-[180%] border border-white/10 rounded-2xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.15),0_4px_24px_6px_rgba(0,0,0,0.10)] text-center py-12 px-6 mx-12">
